...
public class OSGiAuthenticatorValve extends AuthenticatorBase {
	 ...
	 */
	private static final String DATE_ONE = (new SimpleDateFormat()).format(new Date(1));
...
//		}
    ...
    @Override
    protected boolean authenticate(Request request, HttpServletResponse response, org.apache.catalina.deploy.LoginConfig config) throws IOException
    {
